...
namespace Quantum {
  ...
  public unsafe partial struct Input {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + ButtonBoost.GetHashCode();
        hash = hash * 31 + ButtonShoot.GetHashCode();
        return hash;
      }
    }
    ...
    public Boolean IsDown(InputButtons button) {
      switch (button) {
        case InputButtons.ButtonBoost: return ButtonBoost.IsDown;
        case InputButtons.ButtonShoot: return ButtonShoot.IsDown;
        default: return false;
      }
    }
    public Boolean WasPressed(InputButtons button) {
      switch (button) {
        case InputButtons.ButtonBoost: return ButtonBoost.WasPressed;
        case InputButtons.ButtonShoot: return ButtonShoot.WasPressed;
        default: return false;
      }
    }
    static partial void SerializeCodeGen(void* ptr, FrameSerializer serializer) {
        var p = (Input*)ptr;
        Button.Serialize(&p->ButtonBoost, serializer);
        Button.Serialize(&p->ButtonShoot, serializer);
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct DynamicDot : Quantum.IComponent {
  ...
  public unsafe partial struct PlayerCharacter : Quantum.IComponent {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + ShootFrame.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        serializer.Stream.Serialize(&p->ShootFrame);
        serializer.Stream.Serialize(&p->SpawnFrame);
        PlayerRef.Serialize(&p->PlayerRef, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct PlayerCharacterProjectile : Quantum.IComponent {
    public const Int32 SIZE = 32;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 3727;
        hash = hash * 31 + DeathFrame.GetHashCode();
        hash = hash * 31 + Direction.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (PlayerCharacterProjectile*)ptr;
        serializer.Stream.Serialize(&p->DeathFrame);
        EntityRef.Serialize(&p->PlayerCharacter, serializer);
        FPVector2.Serialize(&p->Direction, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct StaticDot : Quantum.IComponent {
  ...
  public unsafe partial interface ISignalSpawnPlayerCharacter : ISignal {
    void SpawnPlayerCharacter(Frame f, EntityRef playerEntityRef);
  }
  public unsafe partial interface ISignalRespawnPlayerCharacter : ISignal {
    void RespawnPlayerCharacter(Frame f, EntityRef playerEntityRef);
  }
  public unsafe partial interface ISignalSpawnPlayerCharacterProjectile : ISignal {
    void SpawnPlayerCharacterProjectile(Frame f, EntityRef playerEntityRef, FPVector2 direction, FPVector2 position);
  }
  public unsafe partial interface ISignalDestroyPlayerCharacterProjectile : ISignal {
    void DestroyPlayerCharacterProjectile(Frame f, EntityRef projectileEntityRef);
  }
  public static unsafe partial class Constants {
  }
  public unsafe partial class Frame {
    private ISignalSpawnPlayerCharacter[] _ISignalSpawnPlayerCharacterSystems;
    private ISignalRespawnPlayerCharacter[] _ISignalRespawnPlayerCharacterSystems;
    private ISignalSpawnPlayerCharacterProjectile[] _ISignalSpawnPlayerCharacterProjectileSystems;
    private ISignalDestroyPlayerCharacterProjectile[] _ISignalDestroyPlayerCharacterProjectileSystems;
    ...
    partial void InitGen() {
      ...
      _ISignalSpawnPlayerCharacterSystems = BuildSignalsArray<ISignalSpawnPlayerCharacter>();
      _ISignalRespawnPlayerCharacterSystems = BuildSignalsArray<ISignalRespawnPlayerCharacter>();
      _ISignalSpawnPlayerCharacterProjectileSystems = BuildSignalsArray<ISignalSpawnPlayerCharacterProjectile>();
      _ISignalDestroyPlayerCharacterProjectileSystems = BuildSignalsArray<ISignalDestroyPlayerCharacterProjectile>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.DynamicDot>();
      BuildSignalsArrayOnComponentRemoved<Quantum.DynamicDot>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.PlayerCharacterProjectile>();
      BuildSignalsArrayOnComponentRemoved<Quantum.PlayerCharacterProjectile>();
      BuildSignalsArrayOnComponentAdded<Quantum.StaticDot>();
      BuildSignalsArrayOnComponentRemoved<Quantum.StaticDot>();
    ...
    partial void SetPlayerInputCodeGen(PlayerRef player, Input input) {
      ...
      i->ButtonBoost = i->ButtonBoost.Update(this.Number, input.ButtonBoost);
      i->ButtonShoot = i->ButtonShoot.Update(this.Number, input.ButtonShoot);
    }
    ...
    public unsafe partial struct FrameSignals {
      public void SpawnPlayerCharacter(EntityRef playerEntityRef) {
        var array = _f._ISignalSpawnPlayerCharacterSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.SpawnPlayerCharacter(_f, playerEntityRef);
          }
        }
      }
      public void RespawnPlayerCharacter(EntityRef playerEntityRef) {
        var array = _f._ISignalRespawnPlayerCharacterSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.RespawnPlayerCharacter(_f, playerEntityRef);
          }
        }
      }
      public void SpawnPlayerCharacterProjectile(EntityRef playerEntityRef, FPVector2 direction, FPVector2 position) {
        var array = _f._ISignalSpawnPlayerCharacterProjectileSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.SpawnPlayerCharacterProjectile(_f, playerEntityRef, direction, position);
          }
        }
      }
      public void DestroyPlayerCharacterProjectile(EntityRef projectileEntityRef) {
        var array = _f._ISignalDestroyPlayerCharacterProjectileSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.DestroyPlayerCharacterProjectile(_f, projectileEntityRef);
          }
        }
      }
    }
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.DynamicDot), Quantum.DynamicDot.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.PlayerCharacterProjectile), Quantum.PlayerCharacterProjectile.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.StaticDot), Quantum.StaticDot.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 4)
        ...
        .Add<Quantum.DynamicDot>(Quantum.DynamicDot.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PlayerCharacter>(Quantum.PlayerCharacter.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PlayerCharacterProjectile>(Quantum.PlayerCharacterProjectile.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.StaticDot>(Quantum.StaticDot.Serialize, null, null, ComponentFlags.None)
        .Finish();
    }
    [Preserve()]
